...
namespace HeavyMetalMachines.Combat
{
	public class BombManagerDispatch : BaseRemoteStub<BombManagerDispatch>, IBombManagerDispatch, IDispatch
	{
		...
		{
			base.Dispatch(base.DispatchDestination(), base.OID, 1030, 7, base.IsReliable, new object[0]);
		}

		public void OnGridGameFinished(byte playerAdress, float finalValue)
		{
			base.Dispatch(base.DispatchDestination(), base.OID, 1030, 8, base.IsReliable, new object[]
			{
				playerAdress,
				finalValue
			});
		...
		{
			base.Dispatch(base.DispatchDestination(), base.OID, 1030, 9, base.IsReliable, new object[]
			{
				playerAddress,
				clientProgress
			});
		...
		{
			base.Dispatch(base.DispatchDestination(), base.OID, 1030, 20, base.IsReliable, new object[0]);
		}

		public void DisputeFinished(int teamKind)
		{
			base.Dispatch(base.DispatchDestination(), base.OID, 1030, 21, base.IsReliable, new object[]
			{
				teamKind
			});
		}
		...
		{
			base.Dispatch(base.DispatchDestination(), base.OID, 1030, 39, base.IsReliable, new object[]
			{
				enable
			});
		}
		...
		{
			base.Dispatch(base.DispatchDestination(), base.OID, 1030, 49, base.IsReliable, new object[]
			{
				id
			});
		}
		...
		{
			base.Dispatch(base.DispatchDestination(), base.OID, 1030, 59, base.IsReliable, new object[]
			{
				trackTeamKind
			});
		}
		...
		{
			base.Dispatch(base.DispatchDestination(), base.OID, 1030, 60, base.IsReliable, new object[]
			{
				trackTeamKind
			});
		}
		...
		{
			base.Dispatch(base.DispatchDestination(), base.OID, 1030, 61, base.IsReliable, new object[]
			{
				trackTeamKind
			});
		}
		...
		{
			base.Dispatch(base.DispatchDestination(), base.OID, 1030, 62, base.IsReliable, new object[]
			{
				trackTeamKind
			});
		}
		...
		{
			base.Dispatch(base.DispatchDestination(), base.OID, 1030, 64, base.IsReliable, new object[0]);
		}

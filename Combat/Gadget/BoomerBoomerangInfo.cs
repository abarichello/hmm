...
{
	[Serializable]
	public class BoomerBoomerangInfo : BasicCannonInfo
	{
		public override Type GadgetType()
		{
			return typeof(BoomerBoomerang);
		}
		...
		public override List<float> GetStats(int index)
		{
			...
			case 23:
				return base.GetStatListModifier(this.IncreasePctByHit, this.IncreasePctByHitUpgrade);
			case 24:
		...
		public string IncreasePctByHitUpgrade;

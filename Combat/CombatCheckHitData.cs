...
namespace HeavyMetalMachines.Combat
{
	...
	public class CombatCheckHitData
	{
		public bool CheckHit(CombatObject causer, CombatObject taker)
		{
			...
			bool flag4 = (this.HitTurrets && taker.IsTurret) || (this.HitWards && taker.IsWard) || (this.HitBuildings && taker.IsBuilding) || (this.HitPlayers && taker.IsPlayer) || (this.HitBoss && taker.IsBoss);

...
{
	public struct DestroyEffect : Mural.IMuralMessage
	{
		public DestroyEffect(EffectEvent effectData, EffectRemoveEvent removeData)
		{
		...
		{
			void OnDestroyEffect(DestroyEffect evt);
		}
	}
}

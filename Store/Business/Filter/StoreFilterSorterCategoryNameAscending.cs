...
{
	public class StoreFilterSorterCategoryNameAscending : IStoreFilterSorter
	{
		public StoreFilterSorterCategoryNameAscending(IGetLocalizedCategoryName getLocalizedCategoryName, IStoreFilterSorter tiebreakerSorter)
		{
		...
		{
			string strA = this._getLocalizedCategoryName.Get(x.ItemCategoryId);
			string strB = this._getLocalizedCategoryName.Get(y.ItemCategoryId);

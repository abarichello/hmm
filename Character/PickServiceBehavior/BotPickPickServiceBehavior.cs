...
namespace HeavyMetalMachines.Character.PickServiceBehavior
{
	public class BotPickPickServiceBehavior : IPickServiceBehavior
	{
		...
		public PickGridResult PickGrid(byte sender)
		{
			...
			this._pickService.DispatchConfirmGridPick(sender, playerByAddress.SelectedGridIndex, playerByAddress.Customizations.SelectedSkin, this._addressGroups.GetGroup(0));

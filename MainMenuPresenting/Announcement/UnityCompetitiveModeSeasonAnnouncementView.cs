...
{
	public class UnityCompetitiveModeSeasonAnnouncementView : MonoBehaviour
	{
		...
		private void Awake()
		{
			this._viewProvider.Bind<UnityCompetitiveModeSeasonAnnouncementView>(this, null);
		}

		private void OnDestroy()
		{
			this._viewProvider.Unbind<UnityCompetitiveModeSeasonAnnouncementView>(null);
		}
